...
const lodash_clonedeep_1 = __importDefault(__nccwpck_require__(56));
...
const main_1 = __nccwpck_require__(844);
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (frameworkVersion != null && frameworkVersion.trim().length) {
        ...
        const pkg = utils_1.bumpDependencies(JSON.parse(readString(pkgFile)), '@reimagined/.*$', frameworkVersion);
        fs_1.writeFileSync(pkgFile, JSON.stringify(pkg, null, 2));
    ...
    if (registry != null) {
        ...
        utils_1.writeNpmRc(path.resolve(appDir, '.npmrc'), registryURL, core.getInput('token'), {
            scopes: utils_1.parseScopes(core.getInput('scopes')),
            core,
        });
    }
    /*
